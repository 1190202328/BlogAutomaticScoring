...
from src.EDU.dataset import TransCollator
...
class NetTrans(nn.Module):
    ...
    def forward(self, input_ids1, input_ids2, input_ids3, aug_flag=None, input_mask1=None, input_mask2=None,
                input_mask3=None, token_type_ids=None, labels=None):
        '''
            Args:
